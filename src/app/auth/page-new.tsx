    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-6xl font-black text-gold-500 animate-pulse-gold">NeverStop</h1>
        ...
        <div className="flex gap-2 bg-slate-800/50 p-1.5 rounded-xl border border-slate-700/50">
          <button
            ...
            className={`flex-1 py-2.5 rounded-lg font-semibold transition-all duration-200 ${
              isSignUp
                ? 'bg-gradient-to-r from-gold-500 to-orange text-slate-900 shadow-lg hover:shadow-[var(--gold)/0.2]'
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <input
              ...
              required
              className="w-full px-6 py-4 bg-slate-800 text-white rounded-xl font-medium text-lg border border-slate-700 focus:outline-none focus:border-gold-500 focus:ring-2 focus:ring-gold-500/20 transition placeholder-slate-500"
            />
            <input
              type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-4 bg-gradient-to-r from-gold-500 to-orange text-slate-900 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-[var(--gold)/0.2] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <p className="text-center text-sm text-slate-500">
          By continuing, you agree to our <a href="#" className="text-gold-500 hover:underline">Terms</a> and <a href="#" className="text-gold-500 hover:underline">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
